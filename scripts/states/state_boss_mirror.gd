...
var previous_spawner_setting: Array[ProjectileSpawnerConfigResource]
...
func enter() -> void:
	...
	previous_spawner_setting = spawner.bullet_configs
	spawner.bullet_configs = [mirror_spawner_setting]
...
func exit() -> void:
	...
	spawner.bullet_configs = previous_spawner_setting
